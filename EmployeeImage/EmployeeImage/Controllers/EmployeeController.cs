...
namespace EmployeeImage.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        {
            return await _context.Employee.Select(x => new Employee()
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutEmployeeModel(int id, [FromForm] Employee employee)
        {
